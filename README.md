...
- **Live share (SharePlay-style)** — one device hosts and others on the same
  ...
  shipped.)*
- **About screen** (Settings → À propos) — explains the app and its
  public-domain hymn sources.
...
authors. This app is an independent, offline reader and is not affiliated with
any organization. Application code is released under the MIT License (see
[`LICENSE`](LICENSE)).
